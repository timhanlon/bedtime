...
import type { BedtimeModuleOptions } from './types/module'
...
export default defineNuxtModule<BedtimeModuleOptions>({
  ...
  async setup(options, nuxt) {
    ...
    const storyGlob = options.stories.glob
    const storyDirectories = options.stories.directories
    const storyViewerRoute = options.viewer.route
...
import type { BedtimeModuleOptions, BedtimeStory, BedtimeStories } from '${resolve('src/types/module.ts')}'

export { BedtimeStory, BedtimeStories }

declare module '@nuxt/types' {
  interface NuxtOptions {
    bedtime?: Partial<BedtimeModuleOptions>
  }
}
